...
ifeq ($(GLUON_TARGET),ath79-generic)
	...
	GLUON_tp-link-tl-wr902ac-v1_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
...
ifeq ($(GLUON_TARGET),ramips-mt7621)
	...
	GLUON_tp-link-eap615-wall-v1_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
	...
	GLUON_wavlink-ws-wn572hp3-4g_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
...
ifeq ($(GLUON_TARGET),ramips-mt76x8)
	...
	GLUON_tp-link-tl-tl-mr6400-v1_SITE_PACKAGES += $(NO_USB_PACKAGES_WITHOUT_HID)
